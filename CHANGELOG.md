...
- Fix and refactor prerelease ([#435](https://github.com/zckv/python-semantic-release/pull/435),
...
- Update click and tomlkit ([#339](https://github.com/zckv/python-semantic-release/pull/339),
...
- **migration**: Fix hyperlink ([#631](https://github.com/zckv/python-semantic-release/pull/631),
...
- **parser**: Documentation for scipy-parser
  ([`45ee34a`](https://github.com/zckv/python-semantic-release/commit/45ee34aa21443860a6c2cd44a52da2f353b960bf))

- **parsers**: Add documentation about commit parsers
  ([`9b55422`](https://github.com/zckv/python-semantic-release/commit/9b554222768036024a133153a559cdfc017c1d91))

- **pypi**: Update docstings in pypi.py
  ([`6502d44`](https://github.com/zckv/python-semantic-release/commit/6502d448fa65e5dc100e32595e83fff6f62a881a))

- **readme**: Add testing instructions
  ([`bb352f5`](https://github.com/zckv/python-semantic-release/commit/bb352f5b6616cc42c9f2f2487c51dedda1c68295))

- **readme**: Fix minor typo
  ([`c22f69f`](https://github.com/zckv/python-semantic-release/commit/c22f69f62a215ff65e1ab6dcaa8e7e9662692e64))

- **readme**: Update readme with information about the changelog command
  ([`56a745e`](https://github.com/zckv/python-semantic-release/commit/56a745ef6fa4edf6f6ba09c78fcc141102cf2871))

### Features

- Add --retry cli option ([#78](https://github.com/zckv/python-semantic-release/pull/78),
  [`3e312c0`](https://github.com/zckv/python-semantic-release/commit/3e312c0ce79a78d25016a3b294b772983cfb5e0f))
...
- Add `additional_options` input for GitHub Action
  ([#477](https://github.com/zckv/python-semantic-release/pull/477),
  [`aea60e3`](https://github.com/zckv/python-semantic-release/commit/aea60e3d290c6fe3137bff21e0db1ed936233776))

- Add `major_on_zero` option
  ([`d324154`](https://github.com/zckv/python-semantic-release/commit/d3241540e7640af911eb24c71e66468feebb0d46))

To control if bump major or not when current major version is zero.

- Add `tag_only` option for `version_source`
  ([#436](https://github.com/zckv/python-semantic-release/pull/436),
  [`cf74339`](https://github.com/zckv/python-semantic-release/commit/cf743395456a86c62679c2c0342502af043bfc3b))

Fixes #354

- Add `upload_to_pypi_glob_patterns` option
  ([`42305ed`](https://github.com/zckv/python-semantic-release/commit/42305ed499ca08c819c4e7e65fcfbae913b8e6e1))

- Add author in commit
  ([`020efaa`](https://github.com/zckv/python-semantic-release/commit/020efaaadf588e3fccd9d2f08a273c37e4158421))

Fixes #40

- Add bitbucket hvcs
  ([`bbbbfeb`](https://github.com/zckv/python-semantic-release/commit/bbbbfebff33dd24b8aed2d894de958d532eac596))

- Add changelog_capitalize configuration
  ([`7cacca1`](https://github.com/zckv/python-semantic-release/commit/7cacca1eb436a7166ba8faf643b53c42bc32a6a7))

Fixes #260

- Add checks for semaphore
  ([`2d7ef15`](https://github.com/zckv/python-semantic-release/commit/2d7ef157b1250459060e99601ec53a00942b6955))

Fixes #44

- Add ci checks for circle ci
  ([`151d849`](https://github.com/zckv/python-semantic-release/commit/151d84964266c8dca206cef8912391cb73c8f206))

- Add ci_checks for Frigg CI
  ([`577c374`](https://github.com/zckv/python-semantic-release/commit/577c374396fe303b6fe7d64630d2959998d3595c))

- Add configuration to customize handling of dists
  ([`2af6f41`](https://github.com/zckv/python-semantic-release/commit/2af6f41b21205bdd192514a434fca2feba17725a))

Relates to #115

- Add git hash to the changelog ([#65](https://github.com/zckv/python-semantic-release/pull/65),
  [`628170e`](https://github.com/zckv/python-semantic-release/commit/628170ebc440fc6abf094dd3e393f40576dedf9b))
...
- Add git-lfs to docker container ([#427](https://github.com/zckv/python-semantic-release/pull/427),
  [`184e365`](https://github.com/zckv/python-semantic-release/commit/184e3653932979b82e5a62b497f2a46cbe15ba87))

- Add option for choosing between versioning by commit or tag
  ([`c0cd1f5`](https://github.com/zckv/python-semantic-release/commit/c0cd1f5b2e0776d7b636c3dd9e5ae863125219e6))

default versioning behaviour is commiting

- Add option to omit tagging ([#341](https://github.com/zckv/python-semantic-release/pull/341),
  [`20603e5`](https://github.com/zckv/python-semantic-release/commit/20603e53116d4f05e822784ce731b42e8cbc5d8f))

- Add option to only parse commits for current working directory
  ([#509](https://github.com/zckv/python-semantic-release/pull/509),
  [`cdf8116`](https://github.com/zckv/python-semantic-release/commit/cdf8116c1e415363b10a01f541873e04ad874220))
...
- Add prerelease functionality ([#413](https://github.com/zckv/python-semantic-release/pull/413),
  [`7064265`](https://github.com/zckv/python-semantic-release/commit/7064265627a2aba09caa2873d823b594e0e23e77))
...
- Add prerelease-patch and no-prerelease-patch flags for whether to auto-bump prereleases
  ([`b4e5b62`](https://github.com/zckv/python-semantic-release/commit/b4e5b626074f969e4140c75fdac837a0625cfbf6))

- Add setting for enforcing textual changelog sections
  ([#502](https://github.com/zckv/python-semantic-release/pull/502),
  [`988437d`](https://github.com/zckv/python-semantic-release/commit/988437d21e40d3e3b1c95ed66b535bdd523210de))
...
- Add signing options to action
  ([`31ad5eb`](https://github.com/zckv/python-semantic-release/commit/31ad5eb5a25f0ea703afc295351104aefd66cac1))

- Add support for commit_message config variable
  ([`4de5400`](https://github.com/zckv/python-semantic-release/commit/4de540011ab10483ee1865f99c623526cf961bb9))
...
- Add support for configuring branch
  ([`14abb05`](https://github.com/zckv/python-semantic-release/commit/14abb05e7f878e88002f896812d66b4ea5c219d4))

Fixes #43

- Add support for environment variables for pypi credentials
  ([`3b383b9`](https://github.com/zckv/python-semantic-release/commit/3b383b92376a7530e89b11de481c4dfdfa273f7b))

- Add support for non-prefixed tags
  ([#366](https://github.com/zckv/python-semantic-release/pull/366),
  [`0fee4dd`](https://github.com/zckv/python-semantic-release/commit/0fee4ddb5baaddf85ed6b76e76a04474a5f97d0a))

- Add support for showing unreleased changelog
  ([`41ef794`](https://github.com/zckv/python-semantic-release/commit/41ef7947ad8a07392c96c7540980476e989c1d83))

Fixes #134

- Add support to finding previous version from tags if not using commit messages
  ([#68](https://github.com/zckv/python-semantic-release/pull/68),
  [`6786487`](https://github.com/zckv/python-semantic-release/commit/6786487ebf4ab481139ef9f43cd74e345debb334))
...
- Add the possibility to load configuration from pyproject.toml
  ([`35f8bfe`](https://github.com/zckv/python-semantic-release/commit/35f8bfef443c8b69560c918f4b13bc766fb3daa2))
...
- Add travis environment checks
  ([`f386db7`](https://github.com/zckv/python-semantic-release/commit/f386db75b77acd521d2f5bde2e1dde99924dc096))
...
- Allow custom environment variable names
  ([#392](https://github.com/zckv/python-semantic-release/pull/392),
  [`372cda3`](https://github.com/zckv/python-semantic-release/commit/372cda3497f16ead2209e6e1377d38f497144883))
...
- Allow template directories to contain a '.' at the top-level
  ([#762](https://github.com/zckv/python-semantic-release/pull/762),
  [`07b232a`](https://github.com/zckv/python-semantic-release/commit/07b232a3b34be0b28c6af08aea4852acb1b9bd56))

- Allow the override of configuration options from cli
  ([`f0ac82f`](https://github.com/zckv/python-semantic-release/commit/f0ac82fe59eb59a768a73a1bf2ea934b9d448c58))
...
- Allow the use of .pypirc for twine uploads
  ([#325](https://github.com/zckv/python-semantic-release/pull/325),
  [`6bc56b8`](https://github.com/zckv/python-semantic-release/commit/6bc56b8aa63069a25a828a2d1a9038ecd09b7d5d))

- Allow user customization of release notes template
  ([#736](https://github.com/zckv/python-semantic-release/pull/736),
  [`94a1311`](https://github.com/zckv/python-semantic-release/commit/94a131167e1b867f8bc112a042b9766e050ccfd1))

Signed-off-by: Bryant Finney <bryant.finney@outlook.com>

- Allow users to get version from tag and write/commit bump to file
  ([`1f9fe1c`](https://github.com/zckv/python-semantic-release/commit/1f9fe1cc7666d47cc0c348c4705b63c39bf10ecc))
...
- Allow using ssh-key to push version while using token to publish to hvcs
  ([#419](https://github.com/zckv/python-semantic-release/pull/419),
  [`7b2dffa`](https://github.com/zckv/python-semantic-release/commit/7b2dffadf43c77d5e0eea307aefcee5c7744df5c))
...
- Bump versions in multiple files ([#246](https://github.com/zckv/python-semantic-release/pull/246),
  [`0ba2c47`](https://github.com/zckv/python-semantic-release/commit/0ba2c473c6e44cc326b3299b6ea3ddde833bdb37))
...
- Changelog filters are specialized per vcs type
  ([#890](https://github.com/zckv/python-semantic-release/pull/890),
  [`76ed593`](https://github.com/zckv/python-semantic-release/commit/76ed593ea33c851005994f0d1a6a33cc890fb908))
...
- Checkout master before publishing
  ([`dc4077a`](https://github.com/zckv/python-semantic-release/commit/dc4077a2d07e0522b625336dcf83ee4e0e1640aa))

Related to #39

- Custom git tag format support ([#373](https://github.com/zckv/python-semantic-release/pull/373),
  [`1d76632`](https://github.com/zckv/python-semantic-release/commit/1d76632043bf0b6076d214a63c92013624f4b95e))
...
- Don't use file to track version, only tag to commit for versioning
  ([`cd25862`](https://github.com/zckv/python-semantic-release/commit/cd258623ee518c009ae921cd6bb3119dafae43dc))

- Extend gitlab to edit a previous release if exists
  ([#934](https://github.com/zckv/python-semantic-release/pull/934),
  [`23e02b9`](https://github.com/zckv/python-semantic-release/commit/23e02b96dfb2a58f6b4ecf7b7812e4c1bc50573d))
...
- Extend support to on-prem GitHub Enterprise Server
  ([#896](https://github.com/zckv/python-semantic-release/pull/896),
  [`4fcb737`](https://github.com/zckv/python-semantic-release/commit/4fcb737958d95d1a3be24db7427e137b46f5075f))
...
- Generate `changelog.md` file ([#266](https://github.com/zckv/python-semantic-release/pull/266),
  [`2587dfe`](https://github.com/zckv/python-semantic-release/commit/2587dfed71338ec6c816f58cdf0882382c533598))

- Get repo version from historical tags instead of config file
  ([`a45a9bf`](https://github.com/zckv/python-semantic-release/commit/a45a9bfb64538efeb7f6f42bb6e7ede86a4ddfa8))
...
- Include additional changes in release commits
  ([`3e34f95`](https://github.com/zckv/python-semantic-release/commit/3e34f957ff5a3ec6e6f984cc4a79a38ce4391ea9))
...
- Make commit message configurable
  ([#184](https://github.com/zckv/python-semantic-release/pull/184),
  [`eb0762c`](https://github.com/zckv/python-semantic-release/commit/eb0762ca9fea5cecd5c7b182504912a629be473b))

- Make the vcs functionalities work with gitlab
  ([`82d555d`](https://github.com/zckv/python-semantic-release/commit/82d555d45b9d9e295ef3f9546a6ca2a38ca4522e))
...
- Override repository_url w REPOSITORY_URL env var
  ([#439](https://github.com/zckv/python-semantic-release/pull/439),
  [`cb7578c`](https://github.com/zckv/python-semantic-release/commit/cb7578cf005b8bd65d9b988f6f773e4c060982e3))

- Rewrite Twine adapter for uploading to artifact repositories
  ([`cfb20af`](https://github.com/zckv/python-semantic-release/commit/cfb20af79a8e25a77aee9ff72deedcd63cb7f62f))
...
- Support Github Enterprise server
  ([`b4e01f1`](https://github.com/zckv/python-semantic-release/commit/b4e01f1b7e841263fa84f57f0ac331f7c0b31954))

- Support toml files for version declaration
  ([#307](https://github.com/zckv/python-semantic-release/pull/307),
  [`9b62a7e`](https://github.com/zckv/python-semantic-release/commit/9b62a7e377378667e716384684a47cdf392093fa))
...
- Update action with configuration options
  ([#518](https://github.com/zckv/python-semantic-release/pull/518),
  [`4664afe`](https://github.com/zckv/python-semantic-release/commit/4664afe5f80a04834e398fefb841b166a51d95b7))

Co-authored-by: Kevin Watson <Kevmo92@users.noreply.github.com>

- Upgrade pydantic to v2 ([#714](https://github.com/zckv/python-semantic-release/pull/714),
  [`5a5c5d0`](https://github.com/zckv/python-semantic-release/commit/5a5c5d0ee347750d7c417c3242d52e8ada50b217))

- Upload distribution files to GitHub Releases
  ([#177](https://github.com/zckv/python-semantic-release/pull/177),
  [`e427658`](https://github.com/zckv/python-semantic-release/commit/e427658e33abf518191498c3142a0f18d3150e07))
...
- Use gitlab-ci or github actions env vars
  ([`8ca8dd4`](https://github.com/zckv/python-semantic-release/commit/8ca8dd40f742f823af147928bd75a9577c50d0fd))

return owner and project name from Gitlab/Github environment variables if available

Issue #363

- V8 ([#619](https://github.com/zckv/python-semantic-release/pull/619),
  [`ec30564`](https://github.com/zckv/python-semantic-release/commit/ec30564b4ec732c001d76d3c09ba033066d2b6fe))
...
- **action**: Use composite action for semantic release
  ([#692](https://github.com/zckv/python-semantic-release/pull/692),
  [`4648d87`](https://github.com/zckv/python-semantic-release/commit/4648d87bac8fb7e6cc361b765b4391b30a8caef8))

Co-authored-by: Bernard Cooke <bernard-cooke@hotmail.com>

- **actions**: Create GitHub Action
  ([`350245d`](https://github.com/zckv/python-semantic-release/commit/350245dbfb07ed6a1db017b1d9d1072b368b1497))

- **actions**: Support PYPI_TOKEN on GitHub Actions
  ([`df2c080`](https://github.com/zckv/python-semantic-release/commit/df2c0806f0a92186e914cfc8cc992171d74422df))
...
- **angular-parser**: Remove scope requirement
  ([`90c9d8d`](https://github.com/zckv/python-semantic-release/commit/90c9d8d4cd6d43be094cda86579e00b507571f98))

- **build**: Allow config setting for build command
  ([#195](https://github.com/zckv/python-semantic-release/pull/195),
  [`740f4bd`](https://github.com/zckv/python-semantic-release/commit/740f4bdb26569362acfc80f7e862fc2c750a46dd))
...
- **build**: Allow falsy values for build_command to disable build step
  ([`c07a440`](https://github.com/zckv/python-semantic-release/commit/c07a440f2dfc45a2ad8f7c454aaac180c4651f70))

- **changelog**: Add `autofit_text_width` filter to template environment
  ([#1062](https://github.com/zckv/python-semantic-release/pull/1062),
  [`83e4b86`](https://github.com/zckv/python-semantic-release/commit/83e4b86abd4754c2f95ec2e674f04deb74b9a1e6))
...
- **changelog**: Add changelog components
  ([#240](https://github.com/zckv/python-semantic-release/pull/240),
  [`3e17a98`](https://github.com/zckv/python-semantic-release/commit/3e17a98d7fa8468868a87e62651ac2c010067711))
...
- **changelog**: Add changelog_table component
  ([#242](https://github.com/zckv/python-semantic-release/pull/242),
  [`fe6a7e7`](https://github.com/zckv/python-semantic-release/commit/fe6a7e7fa014ffb827a1430dbcc10d1fc84c886b))
...
- **changelog**: Add default changelog template in reStructuredText format
  ([#1055](https://github.com/zckv/python-semantic-release/pull/1055),
  [`c2e8831`](https://github.com/zckv/python-semantic-release/commit/c2e883104d3c11e56f229638e988d8b571f86e34))
...
- **changelog**: Add md to rst conversion for markdown inline links
  ([`cb2af1f`](https://github.com/zckv/python-semantic-release/commit/cb2af1f17cf6c8ae037c6cd8bb8b4d9c019bb47e))

- **changelog**: Add PR links in markdown
  ([#282](https://github.com/zckv/python-semantic-release/pull/282),
  [`0448f6c`](https://github.com/zckv/python-semantic-release/commit/0448f6c350bbbf239a81fe13dc5f45761efa7673))
...
- **changelog**: Add PR/MR url linking to default Markdown changelog
  ([`cd8d131`](https://github.com/zckv/python-semantic-release/commit/cd8d1310a4000cc79b529fbbdc58933f4c6373c6))

Resolves: #924, #953

- **changelog**: Add PR/MR url linking to default reStructuredText template
  ([`5f018d6`](https://github.com/zckv/python-semantic-release/commit/5f018d630b4c625bdf6d329b27fd966eba75b017))

Resolves: #924, #953

- **changelog**: Define first release w/o change descriptions for default MD template
  ([`fa89dec`](https://github.com/zckv/python-semantic-release/commit/fa89dec239efbae7544b187f624a998fa9ecc309))

- **changelog**: Define first release w/o change descriptions for default RST template
  ([`e30c94b`](https://github.com/zckv/python-semantic-release/commit/e30c94bffe62b42e8dc6ed4fed6260e57b4d532b))

- **changelog**: Modify changelog template to support changelog updates
  ([#1045](https://github.com/zckv/python-semantic-release/pull/1045),
  [`c18c245`](https://github.com/zckv/python-semantic-release/commit/c18c245df51a9778af09b9dc7a315e3f11cdcda0))
...
- **changelog-md**: Add markdown inline link format macro
  ([`c6d8211`](https://github.com/zckv/python-semantic-release/commit/c6d8211c859442df17cb41d2ff19fdb7a81cdb76))

- **changelogs**: Prefix scopes on commit descriptions in default template
  ([#1093](https://github.com/zckv/python-semantic-release/pull/1093),
  [`560fd2c`](https://github.com/zckv/python-semantic-release/commit/560fd2c0d58c97318377cb83af899a336d24cfcc))
...
- **checks**: Add support for Jenkins CI
  ([#322](https://github.com/zckv/python-semantic-release/pull/322),
  [`3e99855`](https://github.com/zckv/python-semantic-release/commit/3e99855c6bc72b3e9a572c58cc14e82ddeebfff8))
...
- **CI checks**: Add support for GitLab CI checks
  ([`8df5e2b`](https://github.com/zckv/python-semantic-release/commit/8df5e2bdd33a620e683f3adabe174e94ceaa88d9))
...
- **ci_checks**: Add support for bitbucket
  ([`9fc120d`](https://github.com/zckv/python-semantic-release/commit/9fc120d1a7e4acbbca609628e72651685108b364))

- **cli**: Add command for printing the changelog
  ([`336b8bc`](https://github.com/zckv/python-semantic-release/commit/336b8bcc01fc1029ff37a79c92935d4b8ea69203))

Usage: `semantic_release changelog`

- **cli**: Add the possibility to repost the changelog
  ([`4d028e2`](https://github.com/zckv/python-semantic-release/commit/4d028e21b9da01be8caac8f23f2c11e0c087e485))

- **cmd-version**: Add `--tag/--no-tag` option to version command
  ([#752](https://github.com/zckv/python-semantic-release/pull/752),
  [`de6b9ad`](https://github.com/zckv/python-semantic-release/commit/de6b9ad921e697b5ea2bb2ea8f180893cecca920))
...
- **cmd-version**: Changelog available to bundle
  ([#779](https://github.com/zckv/python-semantic-release/pull/779),
  [`37fdb28`](https://github.com/zckv/python-semantic-release/commit/37fdb28e0eb886d682b5dea4cc83a7c98a099422))
...
- **commit-parser**: Enable parsers to flag commit to be ignored for changelog
  ([#1108](https://github.com/zckv/python-semantic-release/pull/1108),
  [`0cc668c`](https://github.com/zckv/python-semantic-release/commit/0cc668c36490401dff26bb2c3141f6120a2c47d0))
...
- **config**: Enable default environment token per hvcs
  ([#774](https://github.com/zckv/python-semantic-release/pull/774),
  [`26528eb`](https://github.com/zckv/python-semantic-release/commit/26528eb8794d00dfe985812269702fbc4c4ec788))

- **configuration**: Add `changelog.default_templates.mask_initial_release` option
  ([`595a70b`](https://github.com/zckv/python-semantic-release/commit/595a70bcbc8fea1f8ccf6c5069c41c35ec4efb8d))

- **context**: Add `mask_initial_release` setting to changelog context
  ([`6f2ee39`](https://github.com/zckv/python-semantic-release/commit/6f2ee39414b3cf75c0b67dee4db0146bbc1041bb))

- **default-changelog**: Add a separate formatted breaking changes section
  ([#1110](https://github.com/zckv/python-semantic-release/pull/1110),
  [`4fde30e`](https://github.com/zckv/python-semantic-release/commit/4fde30e0936ecd186e448f1caf18d9ba377c55ad))
...
- **default-changelog**: Alphabetize commit summaries & scopes in change sections
  ([#1111](https://github.com/zckv/python-semantic-release/pull/1111),
  [`8327068`](https://github.com/zckv/python-semantic-release/commit/83270683fd02b626ed32179d94fa1e3c7175d113))
...
- **gha**: Configure ssh signed tags in GitHub Action
  ([#937](https://github.com/zckv/python-semantic-release/pull/937),
  [`dfb76b9`](https://github.com/zckv/python-semantic-release/commit/dfb76b94b859a7f3fa3ad778eec7a86de2874d68))

Resolves: #936

- **git**: Add a new config for commit author
  ([`aa2c22c`](https://github.com/zckv/python-semantic-release/commit/aa2c22c469448fe57f02bea67a02f998ce519ac3))

- **git**: Add push to GH_TOKEN@github-url
  ([`546b5bf`](https://github.com/zckv/python-semantic-release/commit/546b5bf15466c6f5dfe93c1c03ca34604b0326f2))

- **gitea**: Derives gitea api domain from base domain when unspecified
  ([#675](https://github.com/zckv/python-semantic-release/pull/675),
  [`2ee3f8a`](https://github.com/zckv/python-semantic-release/commit/2ee3f8a918d2e5ea9ab64df88f52e62a1f589c38))
...
- **github**: Add github release changelog helper
  ([`da18795`](https://github.com/zckv/python-semantic-release/commit/da187951af31f377ac57fe17462551cfd776dc6e))

- **github**: Add tag as default release name
  ([`2997908`](https://github.com/zckv/python-semantic-release/commit/2997908f80f4fcec56917d237a079b961a06f990))

- **github**: Retry GitHub API requests on failure
  ([#314](https://github.com/zckv/python-semantic-release/pull/314),
  [`ac241ed`](https://github.com/zckv/python-semantic-release/commit/ac241edf4de39f4fc0ff561a749fa85caaf9e2ae))
...
- **github-actions**: Add `is_prerelease` output to the version action
  ([#1038](https://github.com/zckv/python-semantic-release/pull/1038),
  [`6a5d35d`](https://github.com/zckv/python-semantic-release/commit/6a5d35d0d9124d6a6ee7910711b4154b006b8773))
...
- **github-actions**: Add an action `build` directive to toggle the `--skip-build` option
  ([#1044](https://github.com/zckv/python-semantic-release/pull/1044),
  [`26597e2`](https://github.com/zckv/python-semantic-release/commit/26597e24a80a37500264aa95a908ba366699099e))
...
- **history**: Add angular parser
  ([`91e4f0f`](https://github.com/zckv/python-semantic-release/commit/91e4f0f4269d01b255efcd6d7121bbfd5a682e12))
...
- **history**: Add generate_changelog function
  ([`347f21a`](https://github.com/zckv/python-semantic-release/commit/347f21a1f8d655a71a0e7d58b64d4c6bc6d0bf31))
...
- **history**: Add markdown changelog formatter
  ([`d77b58d`](https://github.com/zckv/python-semantic-release/commit/d77b58db4b66aec94200dccab94f483def4dacc9))

- **history**: Allow customizing changelog_sections
  ([#207](https://github.com/zckv/python-semantic-release/pull/207),
  [`d5803d5`](https://github.com/zckv/python-semantic-release/commit/d5803d5c1668d86482a31ac0853bac7ecfdc63bc))

- **history**: Capitalize changelog messages
  ([`1a8e306`](https://github.com/zckv/python-semantic-release/commit/1a8e3060b8f6d6362c27903dcfc69d17db5f1d36))
...
- **history**: Check all paragraphs for breaking changes
  ([`fec08f0`](https://github.com/zckv/python-semantic-release/commit/fec08f0dbd7ae15f95ca9c41a02c9fe6d448ede0))
...
- **history**: Create emoji parser
  ([#238](https://github.com/zckv/python-semantic-release/pull/238),
  [`2e1c50a`](https://github.com/zckv/python-semantic-release/commit/2e1c50a865628b372f48945a039a3edb38a7cdf0))
...
- **history**: Enable colon defined version
  ([`7837f50`](https://github.com/zckv/python-semantic-release/commit/7837f5036269328ef29996b9ea63cccd5a6bc2d5))
...
- **history**: Set angular parser as the default
  ([`c2cf537`](https://github.com/zckv/python-semantic-release/commit/c2cf537a42beaa60cd372c7c9f8fb45db8085917))
...
- **history**: Support linking compare page in changelog
  ([`79a8e02`](https://github.com/zckv/python-semantic-release/commit/79a8e02df82fbc2acecaad9e9ff7368e61df3e54))

Fixes #218

- **hvcs**: Add gitea support ([#412](https://github.com/zckv/python-semantic-release/pull/412),
  [`b7e7936`](https://github.com/zckv/python-semantic-release/commit/b7e7936331b7939db09abab235c8866d800ddc1a))

- **hvcs**: Add hvcs_domain config option
  ([`ab3061a`](https://github.com/zckv/python-semantic-release/commit/ab3061ae93c49d71afca043b67b361e2eb2919e6))
...
- **logs**: Include scope in changelogs
  ([#281](https://github.com/zckv/python-semantic-release/pull/281),
  [`21c96b6`](https://github.com/zckv/python-semantic-release/commit/21c96b688cc44cc6f45af962ffe6d1f759783f37))
...
- **parsed-commit**: Add linked merge requests list to the `ParsedCommit` object
  ([`9a91062`](https://github.com/zckv/python-semantic-release/commit/9a9106212d6c240e9d3358e139b4c4694eaf9c4b))

- **parser**: Add scipy style parser
  ([#369](https://github.com/zckv/python-semantic-release/pull/369),
  [`51a3921`](https://github.com/zckv/python-semantic-release/commit/51a39213ea120c4bbd7a57b74d4f0cc3103da9f5))

- **parser**: Add support for exclamation point for breaking changes
  ([`a4f8a10`](https://github.com/zckv/python-semantic-release/commit/a4f8a10afcc358a8fbef83be2041129480350be2))
...
- **parser**: Add tag parser
  ([`a7f392f`](https://github.com/zckv/python-semantic-release/commit/a7f392fd4524cc9207899075631032e438e2593c))
...
- **parser**: Make BREAKING-CHANGE synonymous with BREAKING CHANGE
  ([`beedccf`](https://github.com/zckv/python-semantic-release/commit/beedccfddfb360aeebef595342ee980446012ec7))
...
- **parser-angular**: Automatically parse PR/MR numbers from subject lines in commits
  ([`2ac798f`](https://github.com/zckv/python-semantic-release/commit/2ac798f92e0c13c1db668747f7e35a65b99ae7ce))

- **parser-emoji**: Automatically parse PR/MR numbers from subject lines in commits
  ([`bca9909`](https://github.com/zckv/python-semantic-release/commit/bca9909c1b61fdb1f9ccf823fceb6951cd059820))

- **parser-scipy**: Automatically parse PR/MR numbers from subject lines in commits
  ([`2b3f738`](https://github.com/zckv/python-semantic-release/commit/2b3f73801f5760bac29acd93db3ffb2bc790cda0))

- **parser_angular**: Allow customization in parser
  ([`298eebb`](https://github.com/zckv/python-semantic-release/commit/298eebbfab5c083505036ba1df47a5874a1eed6e))
...
- **parsers**: Enable parsers to identify linked issues on a commit
  ([#1109](https://github.com/zckv/python-semantic-release/pull/1109),
  [`f90b8dc`](https://github.com/zckv/python-semantic-release/commit/f90b8dc6ce9f112ef2c98539d155f9de24398301))
...
- **print-version**: Add print-version command to output version
  ([`512e3d9`](https://github.com/zckv/python-semantic-release/commit/512e3d92706055bdf8d08b7c82927d3530183079))
...
- **publish**: Add publishing of changelog to github
  ([`74324ba`](https://github.com/zckv/python-semantic-release/commit/74324ba2749cdbbe80a92b5abbecfeab04617699))

- **pypi**: Add build_commands config
  ([`22146ea`](https://github.com/zckv/python-semantic-release/commit/22146ea4b94466a90d60b94db4cc65f46da19197))
...
- **pypi**: Add option to disable pypi upload
  ([`f5cd079`](https://github.com/zckv/python-semantic-release/commit/f5cd079edb219de5ad03a71448d578f5f477da9c))

- **pypi**: Support easier use of API tokens
  ([`bac135c`](https://github.com/zckv/python-semantic-release/commit/bac135c0ae7a6053ecfc7cdf2942c3c89640debf))
...
- **release-notes**: Add tag comparison link to release notes when supported
  ([#1107](https://github.com/zckv/python-semantic-release/pull/1107),
  [`9073344`](https://github.com/zckv/python-semantic-release/commit/9073344164294360843ef5522e7e4c529985984d))
...
- **release-notes**: Define first release w/o change descriptions in default template
  ([`83167a3`](https://github.com/zckv/python-semantic-release/commit/83167a3dcceb7db16b790e1b0efd5fc75fee8942))

- **repository**: Add support for TWINE_CERT
  ([#522](https://github.com/zckv/python-semantic-release/pull/522),
  [`d56e85d`](https://github.com/zckv/python-semantic-release/commit/d56e85d1f2ac66fb0b59af2178164ca915dbe163))

Fixes #521

- **repository**: Add to settings artifact repository
  ([`f4ef373`](https://github.com/zckv/python-semantic-release/commit/f4ef3733b948282fba5a832c5c0af134609b26d2))
...
- **settings**: Add loading of current parser
  ([`7bd0916`](https://github.com/zckv/python-semantic-release/commit/7bd0916f87a1f9fe839c853eab05cae1af420cd2))

- **utils**: Expand parsable valid git remote url formats
  ([#771](https://github.com/zckv/python-semantic-release/pull/771),
  [`cf75f23`](https://github.com/zckv/python-semantic-release/commit/cf75f237360488ebb0088e5b8aae626e97d9cbdd))
...
- **version**: Add new version print flags to display the last released version and tag
  ([`814240c`](https://github.com/zckv/python-semantic-release/commit/814240c7355df95e9be9a6ed31d004b800584bc0))

- **version-cmd**: Add toggle of `--no-verify` option to `git commit`
  ([#927](https://github.com/zckv/python-semantic-release/pull/927),
  [`1de6f78`](https://github.com/zckv/python-semantic-release/commit/1de6f7834c6d37a74bc53f91609d40793556b52d))
...
- **version-cmd**: Pass `NEW_VERSION` & useful env vars to build command
  ([`ee6b246`](https://github.com/zckv/python-semantic-release/commit/ee6b246df3bb211ab49c8bce075a4c3f6a68ed77))

- **version-config**: Add option to disable 0.x.x versions
  ([`dedb3b7`](https://github.com/zckv/python-semantic-release/commit/dedb3b765c8530379af61d3046c3bb9c160d54e5))

### Performance Improvements

- Improve git history processing for changelog generation
  ([#972](https://github.com/zckv/python-semantic-release/pull/972),
  [`bfda159`](https://github.com/zckv/python-semantic-release/commit/bfda1593af59e9e728c584dd88d7927fc52c879f))
...
- **algorithm**: Refactor bfs search to use queue rather than recursion
  ([`8b742d3`](https://github.com/zckv/python-semantic-release/commit/8b742d3db6652981a7b5f773a74b0534edc1fc15))

- **algorithm**: Simplify logs & use lookup when searching for commit & tag match
  ([`3690b95`](https://github.com/zckv/python-semantic-release/commit/3690b9511de633ab38083de4d2505b6d05853346))

- **parser-angular**: Simplify commit parsing type pre-calculation
  ([`a86a28c`](https://github.com/zckv/python-semantic-release/commit/a86a28c5e26ed766cda71d26b9382c392e377c61))

- **parser-emoji**: Increase speed of commit parsing
  ([`2c9c468`](https://github.com/zckv/python-semantic-release/commit/2c9c4685a66feb35cd78571cf05f76344dd6d66a))

- **parser-scipy**: Increase speed & decrease complexity of commit parsing
  ([`2b661ed`](https://github.com/zckv/python-semantic-release/commit/2b661ed122a6f0357a6b92233ac1351c54c7794e))

### Refactoring

- **debug**: Use logging and click_log instead of ndebug
  ([`15b1f65`](https://github.com/zckv/python-semantic-release/commit/15b1f650f29761e1ab2a91b767cbff79b2057a4c))
